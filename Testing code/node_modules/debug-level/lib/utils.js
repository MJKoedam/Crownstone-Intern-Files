...
var COLORS = ['#0000FF', '#0033FF', '#0066FF', '#3333FF', '#3300FF', '#0000CC', '#0033CC', '#0066CC', '#3333CC', '#3300CC', '#000099', '#003399', '#333399', '#330099', '#000066', '#00FF00', '#00FF33', '#00FF66', '#00FF99', '#006633', '#00CC00', '#00CC33', '#00CC66', '#00CC99', '#006666', '#009900', '#009933', '#009966', '#009999', '#006600', '#00FFFF', '#00CCFF', '#00FFCC', '#00CCCC', '#33CCCC', '#FFFF00', '#FFFF33', '#FFCC33', '#FFCC66', '#FF9900', '#FF9933', '#FF6600', '#FF6633', '#FF0000', '#FF0033', '#FF3300', '#FF3300', '#FF3333', '#CC0000', '#CC0033', '#CC0066', '#FF0066', '#FF3366', '#FF00FF', '#FF33FF', '#CC00CC', '#990099', '#660066'];
...
var inspectNamespaces = function inspectNamespaces(obj) {
  ...
  if (namespaces) return { namespaces: namespaces };
};
