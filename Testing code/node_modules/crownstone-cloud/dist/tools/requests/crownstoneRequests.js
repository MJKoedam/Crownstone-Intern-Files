...
class CrownstoneRequests extends requestorBase_1.RequestorBase {
    ...
    async getCrownstonesInSphere(sphereId) {
        ...
        cache_1.gotAllInSphere(this.cache, sphereId, 'crownstones');
        return body;
    }
    ...
    async getCurrentSwitchState(stoneId) {
        const { body } = await request_1.req("GET", `${this.endpoint}Stones/${stoneId}/currentSwitchStateV2`, this.addSecurity({ ...filter, responseType: 'json' }));
        return body;
    }
}
